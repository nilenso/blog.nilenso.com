...
* **Find cheap ways to prove hypotheses.** What’s the thinnest [slice of cake](https://blog.nilenso.com/blog/2025/09/17/the-common-sense-unit-of-work/) we can offer customers? Can we scrounge up some analytics that can make the case? What’s the simplest experiment we can run? Should we build a PoC, or fire a [tracing bullet](https://wiki.c2.com/?TracerBullets) that tells us how expensive this is going to be?
