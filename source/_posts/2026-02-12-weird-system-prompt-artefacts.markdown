---
title: Weird system prompt artefacts
kind: article
...
This article is an offshoot of a collaboration with [Drew Breunig](https://dbreunig.com) on [How System Prompts Define Agent Behavior](https://www.dbreunig.com/2026/02/10/system-prompts-define-the-agent-as-much-as-the-model.html).
