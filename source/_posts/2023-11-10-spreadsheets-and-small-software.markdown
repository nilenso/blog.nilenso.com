...
If you’ve spent enough time on a sheet you’ve seen these: a copy-paste error, a few rows at the bottom missing from an average[^leancrew], finicky date formats, a relative/absolute referencing mixup, awkward VLOOKUPs, INDEX-MATCHes, workarounds for circular references[^dont-circular-ref] and mega-formulas[^mega-formulas]. Put a few of these in a sheet and it gets messy very quickly.

I ran into the some of the same problems
...
- Good data structures that provide organization but don’t get in the way[^advait-freedom].
...
[^leancrew]: <a href="https://leancrew.com/all-this/2013/04/spreadsheet-programming-problems/">Spreadsheet programming problems</a> – leancrew.com (Blog, 2013)
...
[^trello-is-different]: <a href="https://www.joelonsoftware.com/2012/01/06/how-trello-is-different/">How Trello is different</a> – Joel Spolsky (Blog, 2012) 
[^mira-montes]: <a href="https://www.miramontes.com/writing/spreadsheet-eup/">The spreadsheet interface: A basis for end-user programming</a> – Bonnie A. Nardi, James R. Miller (Paper, 1990)
...
[^felienne-talk]: <a href="https://www.youtube.com/watch?v=0yKf8TrLUOw">Pure Functional Programming in Excel • Felienne Hermans • GOTO 2016</a> (Video, 2016)
[^chandoo-python]: <a href="https://youtu.be/whzmtv9qfIQ?feature=shared&t=719">Python in Excel Review: The Good, The Bad, & The Ugly!</a> Chandoo (Video, 2023)
[^advait-freedom]: <a href="https://advait.org/files/chalhoub_2022_data_structuring.pdf">It’s Freedom to Put Things Where My Mind Wants : Understanding and Improving the User Experience of Structuring Data in Spreadsheets</a> – advait.org (Paper, 2022)
[^copy-bugs]: <a href="https://learn.microsoft.com/en-us/office/troubleshoot/excel/wrongly-assumes-1900-is-leap-year">Excel incorrectly assumes that the year 1900 is a leap year</a> – learn.microsoft.com (Article)
