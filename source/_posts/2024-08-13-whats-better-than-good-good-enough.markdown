...
Product Managers often find themselves in a similar position -- we have to determine the best way to allocate limited resources for maximum impact. And many Product Managers adopt a similar approach in the quest for the "perfect" data-driven decision -- they invest significant effort in instrumenting and collecting _all_ available data, trying to improve the precision of the measurements, and finally setting up dashboards to analyse and visualise what they have. Trying to follow the user journey of each of your users and “solve” all of their problems, though, is unnecessary. 
